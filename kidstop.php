   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn bg-danger text-white my-2 my-sm-0" type="submit">Search</button>
        ...
        <!-- Page Content-->
        <div class="container-fluid" style="background: url('img/kid/How-to-Find-Cheap-Baby-and-Kids-Clothes-with-clothing-apps..jpg');width: 100%; height: 400px;">
          ...
          <div class="row layer ">
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                          <div class="card h-100">
                                <a href="img/kid/171121032020-Orange-Art-Silk-Readymade-Kids-Kurta-Pajama.jpg"><img class="card-img-top" src="img/kid/171121032020-Orange-Art-Silk-Readymade-Kids-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Orange-Art-Silk-Readymade-Kids-Kurta-Pajama</a></h4>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6  mt-3">
                  ...
                  <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/kid/11625527032021-Navy-Blue-Jacquard-Silk-Kids-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Navy-Blue-Jacquard-Silk-Kids-Kurta-Pajam</a></h4>
     ...
     <div class="container  " >
         <div class="Mens">
          ...
          <div class="row layer">
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                          <div class="card h-100">
                                <a href="img/kid/NC-KSKD-06826012021-Pink-Cotton-Silk-Kids-Sharara-Suit.jpg"><img class="card-img-top" src="img/kid/NC-KSKD-06826012021-Pink-Cotton-Silk-Kids-Sharara-Suit.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Pink-Cotton-Silk-Kids-Sharara-Suit</a></h4>
                                    <h5> &#x20a8;<small><subscript> 620/-</subscript><span style="color: #51b315;">(80% off)</span></small><span><i style="padding:8px;" class="fa fa-heart" aria-hidden="true" id="wish" ></i></span></h5>
                                </div> 
                                <div class="card-footer"><small class="text-muted"><span style="font-size: 18px; color: #242a42;" >★ ★ ★ ★ </span>☆</small></div>
                            </div>
