  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn bg-danger text-white my-2 my-sm-0" type="submit">Search</button>
        ...
        <!-- Page Content-->
        <div class="container-fluid" style="background: url('img/man/mantop_slide/cdf1700a6059ddd682c57be6cbf2dd39.jpg');width: 100%; height: 400px;">
          ...
          <div class="row layer ">
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                          <div class="card h-100">
                                <a href="img/man/121-LP-46-MKS-IM13082020-Peach-Dupion-Silk-Readymade-Kurta-Pajama.jpg"><img class="card-img-top" src="img/man/121-LP-46-MKS-IM13082020-Peach-Dupion-Silk-Readymade-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!"> Peach-Dupion-Silk-Readymade-Kurta-Pajama</a></h4>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                 ...
                 <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/man/13344616102019-Green-Jacquard-Readymade-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Green-Jacquard-Readymade-Kurta-Pajama</a></h4>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6  mt-3">
                  ...
                  <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/man/1637715042021-Maroon-Silk-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Maroon-Silk-Kurta-Pajama</a></h4>
     ...
     <div class="container  " >
         <div class="Mens">
          ...
          <div class="row layer">
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                          <div class="card h-100">
                                <a href="img/man/184108012021-Black-Dupion-Silk-Kurta-Pajama.jpg"><img class="card-img-top" src="img/man/184108012021-Black-Dupion-Silk-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Black-Dupion-Silk-Kurta-Pajama</a></h4>
                                    <h5> &#x20a8;<small><subscript> 620/-</subscript><span style="color: #51b315;">(80% off)</span></small><span><i style="padding:8px;" class="fa fa-heart" aria-hidden="true" id="wish" ></i></span></h5>
                                </div> 
                                <div class="card-footer"><small class="text-muted"><span style="font-size: 18px; color: #242a42;" >★ ★ ★ ★ </span>☆</small></div>
                            </div>
