   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="lladiesbottom.php">Bottom Wear</a>
        </div>
      </li>
       <li class="nav-item dropdown">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn bg-danger text-white my-2 my-sm-0" type="submit">Search</button>
        ...
        <!-- Page Content-->
        <div class="container-fluid" style="background: url('img/pexels-bess-hamiti-35188.jpg');width: 100%; height: 400px; background-size: cover;">
          <div class="row text-center text-white pt-5 p-0 m-0 text" style="background: rgba(0,0,0,0.5);width: 100%; height: 400px;background-size: 100% ; ">
            <div class="col-xs-12 col-md-12">
              <h2>Vinayak Cloth Shop..</h2>
              <h3>Kids Diffrent Color Silk Kurta Pajama..</h3>
            </div>
          ...
          <div class="row layer ">
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                          <div class="card h-100">
                                <a href="img/kid/171121032020-Orange-Art-Silk-Readymade-Kids-Kurta-Pajama.jpg"><img class="card-img-top" src="img/kid/1531502112020-Maroon-Art-Silk-Kids-Readymade-Kids-Sherwani.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Maroon-Art-Silk-Kids-Readymade-Kids-Sherwani</a></h4>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                 ...
                 <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/kid/489-KIDS-NC12122019-Blue-Silk-Kids-Readymade-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Blue-Silk-Kids-Readymade-Kurta-Pajama</a></h4>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6  mt-3">
                  ...
                  <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/kid/11625327032021-Beige-Jacquard-Silk-Kids-Kurta-Pajama.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Beige-Jacquard-Silk-Kids-Kurta-Pajam</a></h4>
     ...
     <div class="container  " >
         <div class="Mens">
          ...
          <div class="row layer">
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                          <div class="card h-100">
                                <a href="img/kid/NC-KSKD-06826012021-Pink-Cotton-Silk-Kids-Sharara-Suit.jpg"><img class="card-img-top" src="img/kid/NFS003BLUE24012020-Blue-Brocade-Readymade-Kids-Gown.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Blue-Brocade-Readymade-Kids-Gown</a></h4>
                                    <h5> &#x20a8;<small><subscript> 620/-</subscript><span style="color: #51b315;">(80% off)</span></small><span><i style="padding:8px;" class="fa fa-heart" aria-hidden="true" id="wish" ></i></span></h5>
                                </div> 
                                <div class="card-footer"><small class="text-muted"><span style="font-size: 18px; color: #242a42;" >★ ★ ★ ★ </span>☆</small></div>
                            </div>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6 mt-3">
                 ...
                 <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/kid/NC-KSKD-01526012021-Maroon-Shimmer-Georgette-Kids-Pant-Style-Suit.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Maroon-Shimmer-Georgette-Kids-Pant-Style-Suit</a></h4>
                                    <h5> &#x20a8;<small><subscript> 730/-</subscript><span style="color: #51b315;">(80% off)</span></small><span><i style="padding:8px;" class="fa fa-heart" aria-hidden="true" id="wish" ></i></span></h5>
            ...
            <div class="col-md-3 col-sm-3 col-lg-4 col-xs-6  mt-3">
                  ...
                  <div class="card h-100">
                                <a href="#!"><img class="card-img-top" src="img/kid/NC-KSKD-07026012021-Black-Faux-Georgette-Kids-Sharara-Suit.jpg" alt="..." /></a>
                                <div class="card-body">
                                    <h4 class="card-title"><a href="#!">Black-Faux-Georgette-Kids-Sharara-Suit</a></h4>
                                    <h5> &#x20a8;<small><subscript> 320/-</subscript><span style="color: #51b315;">(80% off)</span></small><span  ><i style="padding:8px;" class="fa fa-heart" aria-hidden="true" id="wish" ></i></span></h5>
